  ...
  <el-container class="container" id="alarmcount">
    ...
    <el-main class="main">
      <el-table ref="tableData" :data="tableData" v-loading="tableLoading" border style="width: 100%">
        ...
        <el-table-column prop="alarm_size" label="报警总数"> </el-table-column>
        <el-table-column prop="alarm_disposes" label="已处理数"> </el-table-column>
        <el-table-column prop="alarm_un_disposes" label="未处理数"> </el-table-column>
        <el-table-column prop="dispose_percent" label="处理率(%)"> </el-table-column>
      </el-table>
    </el-main>
...
import { alarmlist } from '@/api/datacount'
        ...
        .then(res => {
          if (res.code === 200) {
            res.data.forEach(element => {
              ...
              element.police_unit = unit ? unit.label : "";
            });
