							...
							<el-form ref="queryForm" :inline="true" :model="queryForm">
								<el-row>
									...
									<el-col :span="4">
										...
										<el-button icon="el-icon-download" @click="handleDownload('system')">下载</el-button>
									</el-col>
								</el-row>
							</el-form>
						</el-header>
							...
							<el-form ref="queryForm2" :inline="true" :model="queryForm2">
								<el-row>
									...
									<el-col :span="8">
										...
										<el-button icon="el-icon-download" @click="handleDownload('user')">下载</el-button>
									</el-col>
								</el-row>
							</el-form>
						</el-header>
...
import { systemlog, userlog, downloadUserLog, downloadSystemLog } from '@/api/datacount'
...
export default {
	...
	methods: {
		...
		handleDownload(type) {
			...
			const queryObj = { ...this.queryForm,index: 1 }
			delete queryObj.daterange
			const func = type === 'user' ? downloadUserLog : downloadSystemLog
			func(queryObj).then(res => {
				if (res.code === 200) {
